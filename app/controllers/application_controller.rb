class ApplicationController < ActionController::Base
    ...
    private
        ...
        # This method requires a user to be signed in. If no user is signed in, it stores the URL the user was trying to access in the session under :intended_url, and then redirects to the sign in page with an alert.
        def require_signin
            unless current_user
        ...
        # This method requires the current user to be an admin. If they are not, it redirects to the categories page with an alert.
        def require_admin
